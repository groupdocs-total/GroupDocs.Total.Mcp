...
Only the **latest released version** of `GroupDocs.Total.Mcp` (GHCR)
...
- Use GitHub's [private vulnerability reporting](https://github.com/groupdocs-total/GroupDocs.Total.Mcp/security/advisories/new)
...
- Vulnerabilities in the underlying `GroupDocs.Total` engine (a closed-source NuGet
