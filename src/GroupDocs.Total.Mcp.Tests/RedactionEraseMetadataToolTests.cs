...
public class RedactionEraseMetadataToolTests
{
    ...
    public RedactionEraseMetadataToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task RedactionEraseMetadata_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Redaction.RedactionEraseMetadataTool.RedactionEraseMetadata(
                _resolver.Object,
                _storage.Object,
    ...
    [Fact]
    public async Task RedactionEraseMetadata_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task RedactionEraseMetadata_SetsLicense_BeforeResolving()
    {
