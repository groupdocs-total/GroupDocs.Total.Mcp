...
public class MetadataReadMetadataToolTests
{
    ...
    public MetadataReadMetadataToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task MetadataReadMetadata_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Metadata.MetadataReadMetadataTool.MetadataReadMetadata(
                _resolver.Object,
    ...
    [Fact]
    public async Task MetadataReadMetadata_SetsLicense_BeforeResolving()
    {
