...
public class AnnotationGetAnnotationsToolTests
{
    ...
    [Fact]
    public async Task AnnotationGetAnnotations_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Annotation.AnnotationGetAnnotationsTool.AnnotationGetAnnotations(
                _resolver.Object,
    ...
    [Fact]
    public async Task AnnotationGetAnnotations_SetsLicense_BeforeResolving()
    {
