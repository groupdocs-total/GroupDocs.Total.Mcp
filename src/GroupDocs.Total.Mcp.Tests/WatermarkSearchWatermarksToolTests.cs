...
public class WatermarkSearchWatermarksToolTests
{
    ...
    public WatermarkSearchWatermarksToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task WatermarkSearchWatermarks_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Watermark.WatermarkSearchWatermarksTool.WatermarkSearchWatermarks(
                _resolver.Object,
    ...
    [Fact]
    public async Task WatermarkSearchWatermarks_SetsLicense_BeforeResolving()
    {
