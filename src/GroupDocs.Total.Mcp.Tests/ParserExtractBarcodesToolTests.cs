...
public class ParserExtractBarcodesToolTests
{
    ...
    [Fact]
    public async Task ParserExtractBarcodes_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Parser.ParserExtractBarcodesTool.ParserExtractBarcodes(
                _resolver.Object,
    ...
    [Fact]
    public async Task ParserExtractBarcodes_SetsLicense_BeforeResolving()
    {
