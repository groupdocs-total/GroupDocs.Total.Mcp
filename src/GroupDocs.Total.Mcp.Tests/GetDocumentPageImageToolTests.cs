...
public class GetDocumentPageImageToolTests
{
    ...
    [Fact]
    public async Task GetDocumentPageImage_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Common.GetDocumentPageImageTool.GetDocumentPageImage(
                _resolver.Object,
    ...
    [Fact]
    public async Task GetDocumentPageImage_SetsLicense_BeforeResolving()
    {
