...
public class ParserExtractImagesToolTests
{
    ...
    public ParserExtractImagesToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task ParserExtractImages_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Parser.ParserExtractImagesTool.ParserExtractImages(
                _resolver.Object,
                _storage.Object,
    ...
    [Fact]
    public async Task ParserExtractImages_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task ParserExtractImages_SetsLicense_BeforeResolving()
    {
