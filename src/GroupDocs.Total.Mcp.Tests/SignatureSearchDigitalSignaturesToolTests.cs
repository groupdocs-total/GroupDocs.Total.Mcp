...
public class SignatureSearchDigitalSignaturesToolTests
{
    ...
    [Fact]
    public async Task SignatureSearchDigitalSignatures_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Signature.SignatureSearchDigitalSignaturesTool.SignatureSearchDigitalSignatures(
                _resolver.Object,
    ...
    [Fact]
    public async Task SignatureSearchDigitalSignatures_SetsLicense_BeforeResolving()
    {
