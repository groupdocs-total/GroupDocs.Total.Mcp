...
public class SignatureSearchQrCodesToolTests
{
    ...
    [Fact]
    public async Task SignatureSearchQrCodes_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Signature.SignatureSearchQrCodesTool.SignatureSearchQrCodes(
                _resolver.Object,
    ...
    [Fact]
    public async Task SignatureSearchQrCodes_SetsLicense_BeforeResolving()
    {
