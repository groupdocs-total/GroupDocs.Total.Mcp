...
public class SignatureSearchBarcodesToolTests
{
    ...
    [Fact]
    public async Task SignatureSearchBarcodes_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Signature.SignatureSearchBarcodesTool.SignatureSearchBarcodes(
                _resolver.Object,
    ...
    [Fact]
    public async Task SignatureSearchBarcodes_SetsLicense_BeforeResolving()
    {
