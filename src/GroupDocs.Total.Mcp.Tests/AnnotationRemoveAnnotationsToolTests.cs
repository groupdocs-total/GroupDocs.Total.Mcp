...
public class AnnotationRemoveAnnotationsToolTests
{
    ...
    public AnnotationRemoveAnnotationsToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task AnnotationRemoveAnnotations_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Annotation.AnnotationRemoveAnnotationsTool.AnnotationRemoveAnnotations(
                _resolver.Object,
                _storage.Object,
    ...
    [Fact]
    public async Task AnnotationRemoveAnnotations_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task AnnotationRemoveAnnotations_SetsLicense_BeforeResolving()
    {
