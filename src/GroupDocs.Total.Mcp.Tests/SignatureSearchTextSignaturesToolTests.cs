...
public class SignatureSearchTextSignaturesToolTests
{
    ...
    [Fact]
    public async Task SignatureSearchTextSignatures_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Signature.SignatureSearchTextSignaturesTool.SignatureSearchTextSignatures(
                _resolver.Object,
    ...
    [Fact]
    public async Task SignatureSearchTextSignatures_SetsLicense_BeforeResolving()
    {
