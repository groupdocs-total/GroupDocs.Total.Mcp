...
public class MergerMergeToolTests
{
    ...
    public async Task MergerMerge_WhenResolverThrows_PropagatesException()
    {
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Merger.MergerMergeTool.MergerMerge(
                _resolver.Object,
                _storage.Object,
                _licenseManager.Object,
                _output,
                new FileInput { FilePath = "missing.pdf" },
                file2: new FileInput { FilePath = "b.pdf" }));
    }

    [Fact]
    public async Task MergerMerge_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task MergerMerge_SetsLicense_BeforeResolving()
    {
