...
public class ParserExtractTextToolTests
{
    ...
    public ParserExtractTextToolTests()
    {
        _output = new OutputHelper(_storage.Object, Microsoft.Extensions.Options.Options.Create(new McpConfig()));
    }

    [Fact]
    public async Task ParserExtractText_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Parser.ParserExtractTextTool.ParserExtractText(
                _resolver.Object,
    ...
    [Fact]
    public async Task ParserExtractText_SetsLicense_BeforeResolving()
    {
