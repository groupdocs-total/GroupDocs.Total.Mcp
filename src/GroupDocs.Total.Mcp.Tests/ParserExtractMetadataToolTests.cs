...
public class ParserExtractMetadataToolTests
{
    ...
    [Fact]
    public async Task ParserExtractMetadata_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Parser.ParserExtractMetadataTool.ParserExtractMetadata(
                _resolver.Object,
    ...
    [Fact]
    public async Task ParserExtractMetadata_SetsLicense_BeforeResolving()
    {
