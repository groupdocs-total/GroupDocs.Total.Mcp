...
public class SignatureSearchImageSignaturesToolTests
{
    ...
    [Fact]
    public async Task SignatureSearchImageSignatures_WhenResolverThrows_PropagatesException()
    {
        _resolver
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Signature.SignatureSearchImageSignaturesTool.SignatureSearchImageSignatures(
                _resolver.Object,
    ...
    [Fact]
    public async Task SignatureSearchImageSignatures_SetsLicense_BeforeResolving()
    {
