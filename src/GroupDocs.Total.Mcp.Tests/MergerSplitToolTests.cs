...
public class MergerSplitToolTests
{
    ...
    public async Task MergerSplit_WhenResolverThrows_PropagatesException()
    {
        ...
        await Assert.ThrowsAsync<FileNotFoundException>(() =>
            GroupDocs.Total.Mcp.Tools.Merger.MergerSplitTool.MergerSplit(
                _resolver.Object,
                _storage.Object,
    ...
    [Fact]
    public async Task MergerSplit_WhenResolverThrows_DoesNotWriteToStorage()
    {
        _resolver
            .Setup(r => r.ResolveAsync(It.IsAny<FileInput>(), It.IsAny<CancellationToken>()))
            .ThrowsAsync(new FileNotFoundException("missing.pdf"));
    ...
    [Fact]
    public async Task MergerSplit_SetsLicense_BeforeResolving()
    {
